...
const PAULO: UserData = {
  ...
  rv_ativos: [
    ...
    { n: "BPAC11", v: "R$ 18.632", pm: "R$86,85 · 342 ações", r: "-37,27% âš ï¸", rc: "bad", cls: "ação", sb: "sb-r" },
    ...
    { n: "XPAG11 (XP Crédito Agro)", v: "R$ 61.373", pm: "Aplicado R$62.000", r: "-1,01%", rc: "bad", cls: "FI", sb: "sb-a", retorno_posicao: "-1,01%", retorno_fundo_historico: "+42,94%", come_cotas_aviso: "âš ï¸ Come-cotas novembro" },
    // ETFs
  ...
  alertas_list: [
    ...
    { cor: "w", titulo: "BPAC11 â€” -37,27% sobre preÃ§o médio", det: "R$18.632 · PM R$86,85 vs R$54,48. Revisar tese ou stop." },
    { cor: "w", titulo: "TGRE11 â€” -11,69% sobre capital aplicado", det: "Aplicou R$50.000 · vale R$44.156. Fundo listado sob pressão." },
    { cor: "g", titulo: "Proventos previstos julâ€“dez/2026", det: "R$1.520 provisionados (PSSA3, ITSA4, ABEV3, B3SA3 etc.)." },
  ],
  vencimentos: [
    { icon: "ðŸ”´", bg: "var(--danger-bg)", nome: "NTN-B AGO/2026", det: "R$96.512 · 15/08/2026 · 45 dias", badge: "urgente", bc: "sb-r" },
    { icon: "ðŸ”’", bg: "rgba(196,126,58,.1)", nome: "DEB J&F FEV/2028 (3 lotes)", det: "R$94.830 · 21/02/2028 · +15,15% isento", badge: "intocável", bc: "sb-a" },
    { icon: "ðŸ”’", bg: "rgba(196,126,58,.1)", nome: "LCA ORIGINAL DEZ/2028", det: "R$26.700 · 18/12/2028 · 92,5% CDI", badge: "intocável", bc: "sb-a" },
    { icon: "ðŸ”’", bg: "rgba(196,126,58,.1)", nome: "LCAs SICOOB 2030 (×4)", det: "R$105.474 · marâ€“mai/2030 · 92% CDI", badge: "intocável", bc: "sb-a" },
    { icon: "ðŸ”’", bg: "rgba(74,124,89,.12)", nome: "DEB JALLES DEZ/2031", det: "R$70.642 · 15/12/2031 · IPCA+8,5%", badge: "intocável", bc: "sb-a" },
  ],
  resumo: [
